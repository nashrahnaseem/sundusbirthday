...
const gameBody = document.getElementById("game-body"); const $lives = document.getElementById("lives"); var seconds = document.getElementById("timer").textContent; var zombieId = 0; const img = [ "sundus1.jpeg", "sundus2.jpeg", "sundus3.jpeg", "sundus4.jpeg", "sundus5.jpeg", ]; 
// shotgun sound
